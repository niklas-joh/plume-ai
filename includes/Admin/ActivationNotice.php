 ...
 * that the plugin connects to Vectra AI Writer and Design and to
...
class ActivationNotice {
	...
	public static function maybe_display(): void {
		...
		<div class="notice notice-info is-dismissible">
			<p>
				<strong><?php \esc_html_e( 'Vectra AI Writer and Design — External Services & Privacy Notice', 'wp-ai-mind' ); ?></strong>
			</p>
			<p>
				<?php
				\esc_html_e(
					'This plugin connects to Vectra AI Writer and Design and to third-party AI providers (Anthropic Claude, OpenAI, Google Gemini). Only your site address is shared during setup — no content leaves your site until you start a conversation. Your messages are then forwarded to the AI provider on your behalf.',
					'wp-ai-mind'
				);
				?>
				<?php
