...
class ClaudeProvider extends AbstractProvider {
	 ...
	 *   - own API key → direct Anthropic API call (AbstractProvider logs usage)
	 *
	 * @since 1.0.0
	...
	protected function do_complete( CompletionRequest $request ): CompletionResponse {
		...
		// Own key configured — direct Anthropic API call; AbstractProvider::complete() will log usage.
