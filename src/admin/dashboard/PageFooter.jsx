...
export default function PageFooter( { urls, runSetupUrl } ) {
	return (
		<div className="stilus-dash-footer">
			<a href={ urls.settings } className="stilus-dash-footer__link">
				Settings
			</a>
			<div className="stilus-dash-footer__sep" />
			<a href={ runSetupUrl } className="stilus-dash-footer__link">
				Run setup again
			</a>
			<div className="stilus-dash-footer__sep" />
			<a
				href="https://wpaimind.com/docs"
				className="stilus-dash-footer__link"
				target="_blank"
