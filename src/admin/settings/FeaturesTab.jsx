      ...
      <section className="wpaim-settings-section">
        <div className="wpaim-settings-section-header">
          ...
          <p className="wpaim-settings-section-desc">
            Enable or disable individual AI modules. Pro modules require an
            active Vectra AI Writer and Designer Pro licence.
          </p>
        </div>
            ...
            return (
              <div
                ...
                className={`wpaim-feature-card${
                  isLocked ? " wpaim-feature-card--locked" : ""
                }${isEnabled ? " wpaim-feature-card--enabled" : ""}`}
              >
